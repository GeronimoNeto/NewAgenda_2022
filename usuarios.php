        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h3 style= "margin-left:39%; font-size: 30px"class="card-title">Relatório de Usuários</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <a href="editarUser.php?idUp=<?php echo $show-> id_usuario;?>" title="Editar" type="submit" class="btn btn-success">
                    <img style="width: 15px;" src="img/svg/aaa.png"></a>
                    <a href= "deletarUser.php?idDel=<?php echo $show-> id_usuario;?>" onclick="return confirm('Tem certeza que você deseja remover o usuário?')" title="Remover" type="submit" class="btn btn-danger">
